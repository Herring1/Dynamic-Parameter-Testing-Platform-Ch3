...
%%% figure; xpop=[(0:(1/14):1)' (zeros(15,1)) zeros(15,1)]; for t=-1:0.1:1; xobj=H.CalcObj(xpop,t); end
...
% %              plot(0:0.01:1,(1-((0:0.01:1).^(1/(H+thisProblem.DecVarsSplit(3)*((H).^2))))));       % Shang
%              plot(0:0.01:1,(1-((0:0.01:1).^(1/(H+thisProblem.DecVarsSplit(3)*((1+H).^2))))),'b--'); %Modified Shang
% %              plot(0:0.01:1,(1-((0:0.01:1).^(t/(H+thisProblem.DecVarsSplit(3)*((H).^2)))))); %numerator t
