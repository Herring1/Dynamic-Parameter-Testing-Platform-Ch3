...
%                 Algorithm.evalConsumed=Algorithm.evalConsumed+size(Population.decs,1);
        ...
        %Insert the random solutions before or after the rest of the population is updated? 
        %   Current position is before (so not guaranteed to be added to the next population)
        % For each solution 
